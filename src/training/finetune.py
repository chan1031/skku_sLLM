...
# 로그 디렉토리 경로 설정
LOG_DIR = "/home/skku/Desktop/skku_sllm/logs"
...
# 기본 설정
BASE_MODEL_PATH = "/home/skku/Desktop/skku_sllm/models/base/Llama-3-Open-Ko-8B"
DATASET_PATH = "/home/skku/Desktop/skku_sllm/data/processed/skku_qa_instruction.jsonl"
OUTPUT_DIR = f"/home/skku/Desktop/skku_sllm/models/finetuned/skku-llm-{datetime.now().strftime('%Y%m%d')}"
...
def tokenize_function(examples, tokenizer, max_length):
    ...
    for p_ids, p_mask, r_ids, r_mask in zip(
        ...
        # 프롬프트에 대해서는 -100으로 레이블 설정 (손실 계산에서 제외)
        prompt_labels = [-100] * len(p_ids)
        
        # 전체 시퀀스 조합
        combined_ids = p_ids + r_ids[1:]  # 응답의 첫 번째 토큰(BOS) 제외
